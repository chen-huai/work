...
def HCHO():
        root=tkinter.Tk()
        path = tkinter.filedialog.askopenfilenames(initialdir="Z:/Data/%s/66-01-2016-051 UV-Vis (60)"%now, title="Select files",filetypes=[("pdf file", "*.pdf")])
        root.destroy()
...
def Cr():
        ...
        root=tkinter.Tk()
        path = tkinter.filedialog.askopenfilenames(initialdir="Z:/Data/%s/66-01-2013-011 UV-Vis (100)"%now, title="Select files",filetypes=[("pdf file", "*.pdf")])
        root.destroy()
